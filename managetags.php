...
if (isset($_GET['delete'])) {
    $id=$_GET['delete'];
    //echo $id;
    $mysql = "DELETE FROM tags WHERE `tagid`=$id ";
    if ($conn->query($mysql) === true) {
        ...
        echo '<a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>';
            echo '<div>';
                echo 'Tag at ID='.$id.' '.'deleted successfully.';
            echo '</div>';
        echo '</div>';
    } else {
                            ...
                            <?php while ($row = $result->fetch_assoc()) {
                                        echo '<tr>';
                                            ...
                                            echo '<td>';
                                             ...
                                             echo "<a href='edittags.php?edit=$row[tagid]' title='Edit'><img src='resources/images/icons/pencil.png' alt='Edit' /></a>";
                                             echo "<a href='managetags.php?delete=$row[tagid]' title='Delete'><img src='resources/images/icons/cross.png' alt='Delete' /></a>";
